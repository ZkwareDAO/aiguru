...
class FirebaseAuthManager:
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.warning(f"Failed to initialize Firebase Admin SDK: {e} - Firebase features will be disabled")
            return False
...
try:
    ...
    logger.warning(f"Failed to create Firebase auth manager: {e}")
