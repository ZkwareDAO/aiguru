...
marking_scheme_prompts = {
    "zh": """作为一位专业教师，请为上传的题目创建一份详细的评分标准。确保所有数学符号使用标准Unicode字符（如 × ÷ ± √ π ∑ ∫ ≤ ≥ ≠ ∞ θ），严禁使用LaTeX格式如\\sin或\\frac{}{}。
...
注意事项：
   ...
   - 避免主观判断，仅基于题目要求生成方案。""",
    "en": """As a professional teacher, please create a detailed marking scheme for the uploaded problem. Use clear natural language descriptions, ensuring all mathematical symbols use standard Unicode characters (such as × ÷ ± √ π ∑ ∫ ≤ ≥ ≠ ∞ θ), strictly prohibiting LaTeX formats like \\sin or \\frac{}{}.
